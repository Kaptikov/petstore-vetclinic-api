...
namespace petstore_vetclinic_api.Migrations
{
    ...
    [Migration("20240508121344_AddFieldImgUrlToCategoryTable")]
    partial class AddFieldImgUrlToCategoryTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("petstore_vetclinic_api.Models.Favourites.Favourite", b =>
                {
                    b.HasOne("petstore_vetclinic_api.Models.Users.User", "Users")
                        .WithOne("Favourites")
                        .HasForeignKey("petstore_vetclinic_api.Models.Favourites.Favourite", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("petstore_vetclinic_api.Models.Favourites.FavouriteItem", b =>
                {
                    b.HasOne("petstore_vetclinic_api.Models.Favourites.Favourite", null)
                        .WithMany("FavouriteItems")
                        .HasForeignKey("FavouriteId");

                    b.HasOne("petstore_vetclinic_api.Models.Products.Product", "Products")
                        .WithOne("FavouriteItem")
                        .HasForeignKey("petstore_vetclinic_api.Models.Favourites.FavouriteItem", "ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("petstore_vetclinic_api.Models.Products.Product", b =>
                {
                    ...
                    b.HasOne("petstore_vetclinic_api.Models.Orders.Order", null)
                        .WithMany("Products")
